...
# TODO: refactor common Label processes/functions into labelBase
...
class FirstLabel(LabelBase):
    def __init__(
        ...
        **kwargs,
        ...
        kwargs.pop("scale", core.Coords(1, 1))
...
class Label(LabelBase):
    def __init__(
        ...
        **kwargs,
        ...
        # Remove scale from kwargs and explicitly add into SVGshapes.
        kwargs.pop("scale", core.Coords(1, 1))
